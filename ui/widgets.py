...
class DarkEntry(tk.Frame):
    ...
    def __init__(self, master, *, placeholder="", show="", width=76, **kw):
        super().__init__(master, bg=C["border"], padx=4, pady=4)
...
class NeonProgressBar(tk.Frame):
    ...
    def __init__(self, master, *, width=300, height=6, colour=None, **kw):
...
class StrengthBar(tk.Frame):
    ...
    def __init__(self, master, **kw):
        ...
        # Bar background
        bar_bg = tk.Frame(self, bg=C["bg_input"], height=6)
...
class EncryptModeDialog:
    ...
    def _build_ui(self):
        ...
        opt1.pack(fill="both", expand=True, padx=6, pady=6)
        
        # Radio + Title
        radio_row1 = tk.Frame(opt1, bg="#1f2530")
        radio_row1.pack(fill="x", padx=15, pady=(10, 5))
        ...
        desc_container1.pack(fill="x", padx=(20, 15), pady=(3, 10))
        ...
        opt2.pack(fill="both", expand=True, padx=6, pady=6)
        
        # Radio + Title
        radio_row2 = tk.Frame(opt2, bg="#1f2530")
        radio_row2.pack(fill="x", padx=15, pady=(12, 6))
        ...
        desc_container2.pack(fill="x", padx=(20, 15), pady=(3, 12))
        ...
        NeonButton(
            ...
            colour="#39ff14",
            command=self._ok
        ).pack(side="left", ipadx=25, ipady=8, padx=(0, 10))
        ...
        ).pack(side="left", ipadx=25, ipady=8)
