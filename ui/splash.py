...
class SplashScreen:
    def __init__(self, root, on_complete):
        ...
        try:
            ...
            tk.Label(self.splash, text="🛡️", font=("Courier", 72),
                    bg=C["bg_deep"], fg=C["neon_cyan"]).pack(pady=(60, 20))
        
        # App name
        tk.Label(self.splash, text=APP_NAME, font=("Courier", 32, "bold"),
                bg=C["bg_deep"], fg=C["text_white"]).pack()
        
        # Tagline
        tk.Label(self.splash, text=APP_TAGLINE, font=("Courier", 10),
                bg=C["bg_deep"], fg=C["text_dim"]).pack(pady=(5, 30))
