...
class AxCryptApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.footer_frame = ctk.CTkFrame(self, fg_color=C["bg_panel"], height=83, corner_radius=0)
        self.footer_frame.pack(side="bottom", fill="x")
        self.footer_frame.pack_propagate(False)
        self._build_footer()
        
        self.nav_frame = ctk.CTkFrame(self, fg_color=C["bg_panel"], height=73, corner_radius=0)
    ...
    def _setup_fonts(self):
        ...
        self.font_heading = (primary_family, 20, "bold")
        self.font_subheading = (primary_family, 16, "bold")
        self.font_body = (primary_family, 11)
        self.font_body_bold = (primary_family, 11, "bold")
        self.font_small = (primary_family, 9)
        self.font_tiny = (primary_family, 8)
    ...
    def _build_header(self):
        ...
        hdr = ctk.CTkFrame(self, fg_color=C["bg_panel"], height=86, corner_radius=0)
        hdr.pack(fill="x")
    ...
    def _build_footer(self):
        ...
        for icon, name, color in tabs:
            ...
            btn.pack(fill="both", expand=True, padx=6, pady=9)
    ...
    def _build_nav(self):
        ...
        self.nav_frame.pack(side="top", fill="x", after=self.content.master.winfo_children()[0])
        ...
        panic_btn.pack(side="right", padx=(10, 18), pady=14, ipadx=22, ipady=8)
        ...
        logout_btn.pack(side="right", padx=(4, 0), pady=14, ipadx=16, ipady=8)
        ...
        for tab_name, icon in self._TABS:
            ...
            btn.pack(side="left", padx=(3, 3), pady=(7, 7), ipadx=16, ipady=8)
    ...
    def _switch_tab(self, tab_name: str):
        ...
        # Highlight active tab in top nav
        if hasattr(self, 'tab_buttons'):
            for name, btn in self.tab_buttons.items():
                if name == tab_name:
                    btn.configure(fg_color=C["bg_card"], text_color=C["neon_cyan"])
                else:
                    btn.configure(fg_color=C["bg_panel"], text_color=C["text_mid"])
